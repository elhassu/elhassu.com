            ...
            <div className="bg-white overflow-hidden">
                <div className="relative max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mx-auto text-base max-w-prose lg:grid lg:grid-cols-2 lg:gap-8 lg:max-w-none">
                        <div>
                            <h2 className="text-base text-red-600 font-semibold tracking-wide uppercase">Keelan Vella Zerafa</h2>
                                ...
                                <figure>
                                    <div className="aspect-w-12 aspect-h-7 lg:aspect-none">
                                        <img
                                            ...
                                            src="https://cdn.discordapp.com/attachments/913935178899021824/916089323634429972/Keelan.png"
                                            alt="Keelan in his natural habitat"
                                            width={1184}
                                            height={1376}
                                        />
                                    </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3">
                            ...
                            <div className="rounded-lg relative overflow-hidden py-10 px-6 bg-red-700 sm:px-10 xl:p-12">
                                ...
                                <div role="list" className="mt-8 flex space-x-12">
                                    <div className="text-red-200 hover:text-red-100" href="#">
                            ...
                            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                ...
                                <form action="mailto:vellakeelan@gmail.com" method="GET" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                    <div>
